...
$(document).ready(async () => {
	...
	console.log('templage category....', templateCategories);
	showNavbar();
	showFooter();
	// console.log(temp);
	// await test();
...
function getTopNav() {
    ...
    <div class="top-navi">
        <div class="top-left">
            Chào mừng bạn đến với DigitalByte Store - cửa hàng linh kiện đi kèm máy tính
        </div>
        <div class="top-right">
            Follow us:
            <span>
    ...
    <div class="midd-navi">
        <div class="logo">
            <a href="${
                ...
                <span style="font-size: 50px; font-weight: bold; padding-right: 3px;">DigitalByte</span>
    ...
    <div class="bottom-navi mx-5 py-4">
        <div class="left-side" style="font-size: 18px">
            ...
            <div class="blogger" style="margin-right: 24px">
                <a href="${
									location.href.indexOf('client/index.html') > -1 ? '' : '.'
								}./Blogger/index.html" style="text-decoration: none">
...
function showFooter() {
        ...
        <div class="info-shop">
            ...
            <div class="detailInfoShop">
                <div class="hotline">
                    ...
                    <p style="color: #fff; font-size: 18px">(84) 0972270179</p>
                </div>
                <div class="address">
    ...
    <div class="coppyright">
        <p style="color: white; text-align: center">DIGITALBYTE-STORE &#169; 2023. Design by CLUB-WEB-HCMUT</p>
    </div>
    `);
}
